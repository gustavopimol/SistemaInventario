...
<div class="bg-white">
  ...
  <div class="card ">
	<div class="card-header">
	  <h2 class="font-weight-bold">REGISTRO DE CATEGORIA</h2>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="col-8 m-auto borde mb-3" >
			...
			<input type="text" name="categoria" class="form-control text-white font-weight-bold bg-dark border-success mb-1" required="">
